...
spawn-sh-at-startup "killall waybar || waybar -c $HOME/.config/niri/waybar/config.jsonc -s $HOME/.config/niri/waybar/style.css & ~/.config/swww/set-wallpaper"
...
binds {
    ...
    Mod+Ctrl+Return hotkey-overlay-title="Open a Browser: firefox" { spawn "firefox"; }
    ...
    Mod+S+Alt+H     { move-workspace-to-monitor-left; }
    Mod+S+Alt+J     { move-workspace-to-monitor-down; }
    Mod+S+Alt+K     { move-workspace-to-monitor-up; }
    Mod+S+Alt+L     { move-workspace-to-monitor-right; }
